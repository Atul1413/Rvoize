...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\Advertisement\Controllers';

    protected $adminModuleNamespace = 'Modules\Advertisement\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware(['web','dashboard'])
            ...
            ->prefix('admin/module/advertisement')
