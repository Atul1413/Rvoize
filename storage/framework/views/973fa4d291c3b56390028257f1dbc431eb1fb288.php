...
<head>
    ...
    <title><?php echo e($page_title ?? 'Dashboard'); ?> - <?php echo e(setting_item('site_title') ?? 'Rvoize'); ?></title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; <?php echo e(__('Rvoize')); ?> 
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="<?php echo e(__('')); ?>" target="_blank"><?php echo e(__('About Us')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/customer/www/sahila35.sg-host.com/public_html/modules/Layout/admin/app.blade.php ENDPATH**/ ?>