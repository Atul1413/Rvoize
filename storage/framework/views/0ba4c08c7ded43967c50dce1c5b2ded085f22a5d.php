...
<?php if(is_default_lang()): ?>
    ...
    <div class="row" data-condition="sms_driver:is(aquicksms)">
        <div class="col-sm-4">
            <h3 class="form-group-title"><?php echo e(__('Config Aquicksms Driver')); ?></h3>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div data-condition="sms_driver:is(aquicksms)">
                        <div class="form-group">
                            <label class=""><?php echo e(__("AquickSms Auth")); ?></label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_aquicksms_auth" value="<?php echo e(setting_item('sms_aquicksms_auth',config('sms.aquicksms.auth'))); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class=""><?php echo e(__("AquickSms Entity ID")); ?></label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_aquicksms_entity_id" value="<?php echo e(setting_item('sms_aquicksms_entity_id',config('sms.aquicksms.entity_id'))); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class=""><?php echo e(__("AquickSms Template ID")); ?></label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_aquicksms_template_id" value="<?php echo e(setting_item('sms_aquicksms_template_id',config('sms.aquicksms.template_id'))); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class=""><?php echo e(__("From")); ?></label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_aquicksms_from" value="<?php echo e(setting_item('sms_aquicksms_from',config('sms.aquicksms.from'))); ?>">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/customer/www/sahila35.sg-host.com/public_html/modules/Sms/Views/admin/settings/sms.blade.php ENDPATH**/ ?>