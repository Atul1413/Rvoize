                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" min="1" class="form-control" placeholder="<?php echo e(__("0")); ?>" name="number_recruitments" value="<?php echo e(old('number_recruitments',$row->number_recruitments)); ?>">
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/rvoize.com/public_html/modules/Job/Views/frontend/layouts/manage-job/edit-job.blade.php ENDPATH**/ ?>