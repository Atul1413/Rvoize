        ...
        <div class="content">
            <div class="row">
                <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $translate = $plan->translateOrOrigin(app()->getLocale()); ?>
                    <div class="pricing-table col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <div class="price">
                                <?php if($plan->price): ?>
                                    <?php echo e(format_money($plan->price)); ?>
...
<?php /**PATH /home/customer/www/sahila35.sg-host.com/public_html/modules/User/Views/frontend/plan/list.blade.php ENDPATH**/ ?>