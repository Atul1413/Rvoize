    ...
    <div class="text">
        <?php if($row->slug): ?>
            <p class="item-url-demo">
                <?php echo e(__('Permalink')); ?>:
                <span id="permalink">
                    <?php echo e(url(config('companies.companies_route_prefix'))); ?>/<a href="#" class="open-edit-input" data-name="slug"><?php echo e(trim($row->slug)); ?></a>
                </span>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 mb-3">
                            <div class="alert alert-danger">
                                ...
                                <strong><?php echo e(__('Need to complete Company profile before posting a job')); ?></strong>
                            </div>
                        </div>
                        </div>
                        <?php continue; ?>;
                        ...
                        <div class="tabs-box">
                            ...
                            <div class="widget-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(__('Contact Number [Enter country Code eg +91] ')); ?> <span class="text-danger">*</span></label>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/rvoize.com/public_html/modules/Company/Views/frontend/layouts/manageCompany/detail.blade.php ENDPATH**/ ?>