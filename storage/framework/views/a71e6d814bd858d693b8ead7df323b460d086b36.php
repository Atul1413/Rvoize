            ...
            <div class="row">
                <div class="col-lg-9 col-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo e(old('title', @$user->candidate->title)); ?>"
                                                name="title" placeholder="<?php echo e(__('Current position')); ?>" required
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text"
                                                    ...
                                                    placeholder="<?php echo e(__('Expected Salary')); ?>" name="expected_salary"
                                                    class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control"
                                                    placeholder="<?php echo e(__('Experience')); ?>" name="experience_year"
                    ...
                    <div class="ls-widget mb-4">
                        <div class="tabs-box">
                            <div class="widget-title">
                                <h4><?php echo e(__('Location Info')); ?></h4>
                            </div>
                            <div class="widget-content">
                                <!--Location -->
                                <div class="row">
