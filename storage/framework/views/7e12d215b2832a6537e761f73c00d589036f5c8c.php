...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('job.admin.applicants.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar"><?php echo e($row->id ? __('Edit: ').$row->title : __('Add new applicant')); ?></h1>
                    <?php if($row->slug): ?>
            ...
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        <div class="panel">
                            <div class="panel-title"><strong><?php echo e(__("Candidate")); ?> <span class="text-danger">*</span></strong></div>
                            <div class="panel-body">
                                ...
                                <div class="form-group group-cv" style="display: none;">
                                    <label class="control-label"><?php echo e(__("Cv")); ?> <span class="text-danger">*</span></label>
                                    <div class="list-cv">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea name="content" class="d-none has-ckeditor" cols="30"
                                                  rows="10"><?php echo e(old('content', $row->message)); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label"><?php echo e(__("Job")); ?> <span class="text-danger">*</span></label>
                            ...
                            <div class="panel-body">
                                <?php if(is_default_lang()): ?>
                                    <div>
                                        <label><input type="radio" name="status"
                                                      checked value="publish"> <?php echo e(__("Publish")); ?></label>
                                    </div>
                                    <div>
                                        <label><input type="radio" name="status" value="pending"> <?php echo e(__("Pending")); ?>
                                ...
                                <div class="text-right">
                                    <button class="btn btn-primary" type="submit"><i
                                            class="fa fa-save"></i> <?php echo e(__('Save Changes')); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\rvoize\modules/Job/Views/admin/job/detail-applicant.blade.php ENDPATH**/ ?>