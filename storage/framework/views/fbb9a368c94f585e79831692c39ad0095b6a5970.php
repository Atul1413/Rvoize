    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" value="<?php echo e(old('title',@$candidate->title)); ?>" name="title" placeholder="<?php echo e(__("Current position")); ?>" required class="form-control">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
...
<?php /**PATH /home/customer/www/sahila35.sg-host.com/public_html/modules/Candidate/Views/admin/candidate/form.blade.php ENDPATH**/ ?>