...
<?php $__env->startSection('content'); ?>
    ...
    <form method="post" action="<?php echo e(route('user.company.advertisement.store.ads',['id' => '-1'])); ?>" enctype="multipart/form-data" class="default-form">
        <?php echo csrf_field(); ?>
        <div class="upper-title-box">
            <div class="row">
                <div class="col-md-9">
                    <h4><?php echo e(__('New Advertisement')); ?></h4>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo e(old('title')); ?>" placeholder="<?php echo e(__("Title")); ?>" name="title" required class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="url" required class="form-control" value="<?php echo e(old('url')); ?>" placeholder="<?php echo e(__("Advertisement URL")); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo e(old( 'start_date')); ?>" placeholder="YYYY/MM/DD" name="start_date" autocomplete="false" required class="form-control has-datepicker bg-white">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(__("End Date")); ?> <span class="required">*</span></label>
                                            <input type="text" value="<?php echo e(old( 'end_date')); ?>" placeholder="YYYY/MM/DD" name="end_date" autocomplete="false" required class="form-control has-datepicker bg-white">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <?php echo \Modules\Media\Helpers\FileHelper::fieldUpload('banner'); ?>
                ...
                <div class="ls-widget">
                    <div class="tabs-box">
                        ...
                        <div class="widget-content pb-4">
                            <?php if(is_default_lang()): ?>
                                <div>
                                    <label><input checked type="radio" name="status" value="publish"> <?php echo e(__("Publish")); ?></label>
                                </div>
                                <div>
                                    <label><input type="radio" name="status" value="draft"> <?php echo e(__("Draft")); ?></label>
                                </div>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\rvoize\modules/Advertisement/Views/frontend/layouts/manage-ads/create-ads.blade.php ENDPATH**/ ?>