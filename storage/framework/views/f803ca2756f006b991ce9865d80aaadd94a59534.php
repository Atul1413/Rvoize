<div class="btn-box">
    <?php if($row->isOpen()): ?>
        <?php if(empty(setting_item('job_hide_job_apply')) && $row->apply_type == 'email'): ?>
        ...
        <?php elseif(empty(setting_item('job_hide_job_apply')) && $row->apply_type == 'external'): ?>
...
<?php /**PATH /home/customer/www/sahila35.sg-host.com/public_html/modules/Job/Views/frontend/layouts/details/apply-button.blade.php ENDPATH**/ ?>