    ...
    <div class="main-box">
        ...
        <div class="outer-box">
            ...
            <?php if(!(isset($exception) && $exception->getStatusCode() == 404)): ?>
                ...
                <div class="btn-box">
                    <?php if(!Auth::id()): ?>
                        <a href="#" class="theme-btn btn-style-three"><span class="bc-call-modal login"><?php echo e(__("Login")); ?></span></a>
<a href="#" class="theme-btn btn-style-three"><span class="bc-call-modal signup"><?php echo e(__("Register")); ?></span></a>
...
<?php /**PATH /home/customer/www/rvoize.com/public_html/modules/Layout/parts/header.blade.php ENDPATH**/ ?>