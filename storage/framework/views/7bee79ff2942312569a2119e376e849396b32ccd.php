                    ...
                    <div class="panel-body panel-index">
                        <form action="<?php echo e(route('location.admin.store',['id'=>'-1','lang'=>request()->query('lang')])); ?>" method="post">
                            ...
                            <div class="form-group">
                                <label><?php echo e(__("Zipcode")); ?></label>
                                <input type="text" value="<?php echo e($row->zipcode); ?>" placeholder="<?php echo e(__("Zipcode")); ?>" name="zipcode" class="form-control">
                            </div>
                        ...
                        <form action="" class="bravo-form-item">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="slug d-none d-md-table-cell"><?php echo e(__("Slug")); ?></th>
                                    <th class="d-none d-md-table-cell"><?php echo e(__("Zipcode")); ?></th>
                                ...
                                <?php if( count($rows) > 0): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-md-table-cell"><?php echo e($row->slug); ?></td>
                                        <td class="d-none d-md-table-cell"><?php echo e($row->zipcode); ?></td>
    ...
    <script>
        jQuery(function ($) {
            ...
            new BravoMapEngine('map_content', {
                disableScripts:true,
                fitBounds: true,
                center: [<?php echo e($row->map_lat ?? setting_item('default_location_lat', "51.505")); ?>, <?php echo e($row->map_lng ?? setting_item('default_location_lng', "-0.09")); ?>],
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/sahila35.sg-host.com/public_html/modules/Location/Views/admin/index.blade.php ENDPATH**/ ?>