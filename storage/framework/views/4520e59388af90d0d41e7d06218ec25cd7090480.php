                            ...
                            <?php if($rows->total() > 0): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($row->status); ?>">
                                        ...
                                        <?php if(setting_item('job_need_approve')): ?>
                                        <td> <?php if(empty($row->is_approved) || $row->is_approved == 'approved'): ?> 
                                            ...
                                            <span class="badge badge-warning"> <?php echo e(__('Waiting for approve')); ?> </span>
                                            <?php endif; ?>
                                        </td>
                                        <?php endif; ?>
                                        <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/sahila35.sg-host.com/public_html/modules/Job/Views/admin/job/index.blade.php ENDPATH**/ ?>