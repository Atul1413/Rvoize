        ...
        <div class="row form-group" id="company_show">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="company_name" id="company_name" autocomplete="off" placeholder="<?php echo e(__("Company Name")); ?>">
                    <i class="input-icon field-icon icofont-waiter-alt"></i>
    ...
    <?php if(setting_item('facebook_enable') or setting_item('google_enable') or setting_item('twitter_enable') or setting_item('linkedin_enable')): ?>
        <div class="bottom-box" id="social_auth_candidate">
            ...
            <div class="btn-box row">
                <?php if(setting_item('facebook_enable')): ?>
                    <div class="col-lg-6 col-md-12">
                        <a href="<?php echo e(url('/social-login/facebook/candidate')); ?>" class="theme-btn social-btn-two facebook-btn btn_login_fb_link"><i class="fab fa-facebook-f"></i><?php echo e(__('Facebook')); ?></a>
                    </div>
                <?php endif; ?>
                <?php if(setting_item('google_enable')): ?>
                    <div class="col-lg-6 col-md-12">
                        <a href="<?php echo e(url('social-login/google/candidate')); ?>" class="theme-btn social-btn-two google-btn btn_login_gg_link"><i class="fab fa-google"></i><?php echo e(__('Google')); ?></a>
                    </div>
                <?php endif; ?>
                <?php if(setting_item('twitter_enable')): ?>
                    <div class="col-lg-6 col-md-12">
                        <a href="<?php echo e(url('social-login/twitter/candidate')); ?>" class="theme-btn social-btn-two twitter-btn btn_login_tw_link"><i class="fab fa-twitter"></i> <?php echo e(__("Log In via Twitter")); ?></a>
                    </div>
                <?php endif; ?>
                <?php if(setting_item('linkedin_enable')): ?>
                    <div class="col-lg-6 col-md-12">
                        <a href="<?php echo e(url('social-login/linkedin/candidate')); ?>" class="theme-btn social-btn-two linkedin-btn btn_login_lk_link"><i class="fab fa-linkedin"></i> <?php echo e(__("Log In via LinkedIn")); ?></a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
     ...
     <div class="bottom-box" id="social_auth_employer">
         ...
         <div class="btn-box row">
             <?php if(setting_item('facebook_enable')): ?>
                 <div class="col-lg-6 col-md-12">
                     <a href="<?php echo e(url('/social-login/facebook/employer')); ?>" class="theme-btn social-btn-two facebook-btn btn_login_fb_link"><i class="fab fa-facebook-f"></i><?php echo e(__('Facebook')); ?></a>
                 </div>
             <?php endif; ?>
             <?php if(setting_item('google_enable')): ?>
                 <div class="col-lg-6 col-md-12">
                     <a href="<?php echo e(url('social-login/google/employer')); ?>" class="theme-btn social-btn-two google-btn btn_login_gg_link"><i class="fab fa-google"></i><?php echo e(__('Google')); ?></a>
                 </div>
             <?php endif; ?>
             <?php if(setting_item('twitter_enable')): ?>
                 <div class="col-lg-6 col-md-12">
                     <a href="<?php echo e(url('social-login/twitter/employer')); ?>" class="theme-btn social-btn-two twitter-btn btn_login_tw_link"><i class="fab fa-twitter"></i> <?php echo e(__("Log In via Twitter")); ?></a>
                 </div>
             <?php endif; ?>
             <?php if(setting_item('linkedin_enable')): ?>
                 <div class="col-lg-6 col-md-12">
                     <a href="<?php echo e(url('social-login/linkedin/employer')); ?>" class="theme-btn social-btn-two linkedin-btn btn_login_lk_link"><i class="fab fa-linkedin"></i> <?php echo e(__("Log In via LinkedIn")); ?></a>
                 </div>
             <?php endif; ?>
         </div>
     </div>
...
<?php /**PATH /home/customer/www/rvoize.com/public_html/modules/Layout/auth/register-form.blade.php ENDPATH**/ ?>