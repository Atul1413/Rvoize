    ...
    <ul class="job-overview">
        ...
        <?php if($row->hours): ?>
            <li>
                ...
                <span><?php echo e($row->hours); ?> <?php if($row->hours_type): ?>/ <?php echo e($row->hours_type_name); ?> <?php endif; ?></span>
            </li>
        <?php endif; ?>
        ...
        <?php if($row->number_recruitments): ?>
            <li>
                <span class="icon">
                ...
                <h5><?php echo e(__("Number Of Recruitments:")); ?></h5>
                <span><?php echo e($row->number_recruitments); ?></span>
            </li>
        <?php endif; ?>
        <?php if($row->gender): ?>
            <li>
...
<?php /**PATH /home/customer/www/sahila35.sg-host.com/public_html/modules/Job/Views/frontend/layouts/details/overview.blade.php ENDPATH**/ ?>