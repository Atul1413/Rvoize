                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 mb-3">
                                <div class="alert alert-danger">
                                    ...
                                    <strong><?php echo e(__('Need to complete Candidate profile before applying for a job')); ?></strong>
                                </div>
                            </div>
                        </div>
                        <?php continue; ?>;
        ...
        <form action="<?php echo e(route('user.candidate.store')); ?>" method="post" class="default-form">
            ...
            <div class="row">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label><?php echo e(__('Contact Number(Enter Country code eg. +91')); ?> <span
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label><?php echo e(__('Website/Github (Optional)')); ?></label>
                                ...
                                <div class="form-group-item">
                                    <div class="g-items-header">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3"><?php echo e(__('Achievement')); ?></div>
                                ...
                                <div class="form-group-item">
                                    <div class="g-items-header">
                                        <div class="row">
                                            <div class="col-md-2"><?php echo e(__('Year')); ?></div>
                                            <div class="col-md-3"><?php echo e(__('Location')); ?></div>
                                            <div class="col-md-3"><?php echo e(__('Acheivement')); ?></div>
                                            <div class="col-md-3"><?php echo e(__('More Information')); ?></div>
                                            <div class="col-md-1"></div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-3 col-12">
                    <div class="ls-widget mb-4 ">
                        <div class="tabs-box">
                            <div class="widget-title"><strong><?php echo e(__('Profile below 2 MB')); ?></strong></div>
                            <div class="widget-content">
                                <div class="form-group">
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/rvoize.com/public_html/modules/Candidate/Views/frontend/profile/edit.blade.php ENDPATH**/ ?>