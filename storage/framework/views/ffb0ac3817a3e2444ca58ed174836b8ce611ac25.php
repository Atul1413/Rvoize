            ...
            <div class="btn-box row">
                <?php if(setting_item('facebook_enable')): ?>
                    <div class="col-lg-6 col-md-12">
                        <a href="<?php echo e(url('/social-login/facebook/candidate')); ?>" data-channel="facebook" class="theme-btn social-btn-two facebook-btn"><i class="fab fa-facebook-f"></i> <?php echo e(__("Log In via Facebook")); ?></a>
                    </div>
                <?php endif; ?>
                <?php if(setting_item('google_enable')): ?>
                    <div class="col-lg-6 col-md-12">
                        <a href="<?php echo e(url('social-login/google/candidate')); ?>" data-channel="google" class="theme-btn social-btn-two google-btn"><i class="fab fa-google"></i> <?php echo e(__("Log In via Gmail")); ?></a>
                    </div>
                <?php endif; ?>
                <?php if(setting_item('twitter_enable')): ?>
                    <div class="col-lg-6 col-md-12">
                        <a href="<?php echo e(url('social-login/twitter/candidate')); ?>" data-channel="twitter" class="theme-btn social-btn-two twitter-btn"><i class="fab fa-twitter"></i> <?php echo e(__("Log In via Twitter")); ?></a>
                    </div>
                <?php endif; ?>
                <?php if(setting_item('linkedin_enable')): ?>
                    <div class="col-lg-6 col-md-12">
                        <a href="<?php echo e(url('social-login/linkedin/candidate')); ?>" data-channel="linkedin" class="theme-btn social-btn-two linkedin-btn"><i class="fab fa-linkedin"></i> <?php echo e(__("Log In via LinkedIn")); ?></a>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
...
<?php /**PATH /home/customer/www/sahila35.sg-host.com/public_html/modules/Layout/auth/login-form.blade.php ENDPATH**/ ?>