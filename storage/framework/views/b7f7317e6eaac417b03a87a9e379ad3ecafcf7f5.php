    ...
    <form action="<?php echo e(url('admin/module/user/changepass/'.$row->id)); ?>" method="post">
        ...
        <div class="container">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar"><?php echo e($row->id ? __('Change Password: ').$row->getDisplayName() : __('Add new user')); ?></h1>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/rvoize.com/public_html/modules/User/Views/admin/password.blade.php ENDPATH**/ ?>