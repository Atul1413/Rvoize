        ...
        <div class="auto-container">
            <div class="row">
                ...
                <div class="sidebar-column col-lg-4 col-md-12 col-sm-12">
                    ...
                    <?php echo $__env->make('Job::frontend.layouts.details.contact',['origin_id'=>$row->owner_id,'job_id'=>false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/customer/www/sahila35.sg-host.com/public_html/modules/Company/Views/frontend/layouts/details/ver/company-single-v1.blade.php ENDPATH**/ ?>