                    ...
                    <div class="col-md-3">
                        ...
                        <?php if(is_default_lang()): ?>
                            ...
                            <?php if(setting_item('job_need_approve')): ?>
                                <div class="panel">
                                    <div class="panel-title"><strong><?php echo e(__('Approval Status')); ?></strong></div>
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <label><?php echo e(__('Approval Type')); ?></label>
                                            <select name="is_approved" class="form-control">
                                                <option value="draft" <?php if(old('is_approved', $row->is_approved) == 'draft'): ?> selected <?php endif; ?> ><?php echo e(__("Draft")); ?></option>
                                                <option value="waiting" <?php if(old('is_approved', $row->is_approved) == 'waiting'): ?> selected <?php endif; ?> ><?php echo e(__("Waiting for approval")); ?></option>
                                                <option value="approved" <?php if(old('is_approved', $row->is_approved) == 'approved' || old('apply_type', $row->is_approved) == ""): ?> selected <?php endif; ?> ><?php echo e(__("Approved")); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        jQuery(function ($) {
            new BravoMapEngine('map_content', {
                disableScripts: true,
                fitBounds: true,
                center: [<?php echo e(old('map_lat', $row->map_lat) ?? setting_item('default_location_lat', "51.505")); ?>, <?php echo e(old('map_lng', $row->map_lng) ?? setting_item('default_location_lng', "-0.09")); ?>],
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/rvoize.com/public_html/modules/Job/Views/admin/job/detail.blade.php ENDPATH**/ ?>