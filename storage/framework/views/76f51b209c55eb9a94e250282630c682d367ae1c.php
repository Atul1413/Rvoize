                        ...
                        <form class="bravo-form-item">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th width="60px"><?php echo e(__("Max Ads")); ?></th>
                                ...
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class=""><?php echo e($row->max_service ? $row->max_service : __('None')); ?></td>
                                        <td class=""><?php echo e($row->max_ads ? $row->max_ads : __('None')); ?></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/sahila35.sg-host.com/public_html/modules/User/Views/admin/plan/index.blade.php ENDPATH**/ ?>