                            ...
                            <div class="row">
                                ...
                                <?php if($location_style == 'autocomplete'): ?>
                                    ...
                                    <div class="form-group col-lg-4 col-md-12 col-sm-12 location smart-search">
                                        <input type="text" class="smart-search-location parent_text form-control" placeholder="<?php echo e(__("Location")); ?>" value="<?php echo e($location_name); ?>" data-onLoad="<?php echo e(__("Loading...")); ?>"
...
<!-- End Banner Section-->
<?php /**PATH /home/customer/www/rvoize.com/public_html/modules/Template/Views/frontend/blocks/hero-banner/style_1.blade.php ENDPATH**/ ?>